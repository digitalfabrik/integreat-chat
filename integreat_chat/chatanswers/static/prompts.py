...
"""
    ...
    LANGUAGE_CLASSIFICATION = """Determine the language of the following message.
If the message can be classified as {estimated_lang}, respond with {estimated_lang}.
If not, provide the most likely BCP47 language tag for the message.
